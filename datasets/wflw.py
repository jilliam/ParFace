...
class WFLW(FaceDataset):
    ...
    def __init__(self, root, cache_root=None, return_landmark_heatmaps=True, use_cache=False, **kwargs):
        ...
        super().__init__(root=root, cache_root=cache_root, fullsize_img_dir=fullsize_img_dir,
                         return_landmark_heatmaps=return_landmark_heatmaps, use_cache=use_cache, **kwargs)
...
if __name__ == '__main__':
    ...
    ds.filter_labels({'pose': 0, 'occlusion': 1, 'make-up': 1})
    ...
    for data in dl:
        ...
        vis.vis_square(images, nCols=5, fx=1., fy=1., normalize=False)
        # print(lms.shape)
